...
public class marks2 extends AppCompatActivity {
                ...
                try {
                    ...
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            String st = dataSnapshot.child("cie2").child(regno).child(dm).child("tot").getValue().toString();
                           if(n1<3)
                            {
                                if(n2<3)
                                {
                            ...
                            if (st.equals(str)) {
                                if (n1 == 0)
                                    databaseReference.child("cie2").child(regno).child(dm).child("q1").setValue("0");
                                else
                                    databaseReference.child("cie2").child(regno).child(dm).child("q1").setValue(n1);
                                if (n2 == 0)
                                    databaseReference.child("cie2").child(regno).child(dm).child("q2").setValue("0");
                                else
                                    databaseReference.child("cie2").child(regno).child(dm).child("q2").setValue(n2);
                                if (n3 == 0)
                                    databaseReference.child("cie2").child(regno).child(dm).child("q3").setValue("0");
                                else
                                    databaseReference.child("cie2").child(regno).child(dm).child("q3").setValue(n3);
                                if (n4 == 0)
                                    databaseReference.child("cie2").child(regno).child(dm).child("q4").setValue("0");
                                else
                                    databaseReference.child("cie2").child(regno).child(dm).child("q4").setValue(n4);
                                if (n5 == 0)
                                    databaseReference.child("cie2").child(regno).child(dm).child("q5").setValue("0");
                                else
                                    databaseReference.child("cie2").child(regno).child(dm).child("q5").setValue(n5);
                                if (n6 == 0)
                                    databaseReference.child("cie2").child(regno).child(dm).child("q6").setValue("0");
                                else
                                    databaseReference.child("cie2").child(regno).child(dm).child("q6").setValue(n6);
                                if (n7 == 0)
                                    databaseReference.child("cie2").child(regno).child(dm).child("q7").setValue("0");
                                else
                                    databaseReference.child("cie2").child(regno).child(dm).child("q7").setValue(n7);
                                if (n8 == 0)
                                    databaseReference.child("cie2").child(regno).child(dm).child("q8").setValue("0");
                                else
                                    databaseReference.child("cie2").child(regno).child(dm).child("q8").setValue(n8);
                                if (n9a == 0)
                                    databaseReference.child("cie2").child(regno).child(dm).child("q9a").setValue("0");
                                else
                                    databaseReference.child("cie2").child(regno).child(dm).child("q9a").setValue(n9a);
                                if (n9b == 0)
                                    databaseReference.child("cie2").child(regno).child(dm).child("q9b").setValue("0");
                                else
                                    databaseReference.child("cie2").child(regno).child(dm).child("q9b").setValue(n9b);
                                if (n10a == 0)
                                    databaseReference.child("cie2").child(regno).child(dm).child("qa10").setValue("0");
                                else
                                    databaseReference.child("cie2").child(regno).child(dm).child("qa10").setValue(n10a);
                                if (n10b == 0)
                                    databaseReference.child("cie2").child(regno).child(dm).child("qb10").setValue("0");
                                else
                                    databaseReference.child("cie2").child(regno).child(dm).child("qb10").setValue(n10b);
